...
_Rewritten for R by ANA RIVERA - GIS ASSISTANT - STANFROD GEOSPATIAL CENTER - <ARIVERAR@STANFORD.EDU>_
...
* _rgdal_: Read and write geospatial data.`install.packages("rgdal")` <https://cran.r-project.org/web/packages/rgdal/index.html>
